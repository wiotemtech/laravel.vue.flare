...
export default {
    ...
    data() {
        return {
            isDarkMode: false,
            images: [
                { src: "/assets/images/flare.png", alt: "Gallery Image 1" },
                { src: "/assets/images/flare.png", alt: "Gallery Image 2" },
                { src: "/assets/images/flare.png", alt: "Gallery Image 3" },
                { src: "/assets/images/flare.png", alt: "Gallery Image 4" },
                { src: "/assets/images/flare.png", alt: "Gallery Image 5" },
                { src: "/assets/images/flare.png", alt: "Gallery Image 6" },
                { src: "/assets/images/flare.png", alt: "Gallery Image 7" },
                { src: "/assets/images/flare.png", alt: "Gallery Image 8" },
                { src: "/assets/images/flare.png", alt: "Gallery Image 9" },
                { src: "/assets/images/flare.png", alt: "Gallery Image 10" },
                  { src: "/assets/images/flare.png", alt: "Gallery Image 9" },
                { src: "/assets/images/flare.png", alt: "Gallery Image 10" },
            ],
            showPopup: false,
